...
const LayoutInner = () => {
  ...
  return (
    <LayoutContext.Provider value={{ openCreateBoard, openCommand, toggleMobile, closeMobile }}>
      <div className="h-screen overflow-hidden relative">
        ...
        {mobileOpen && (
          <div
            onClick={closeMobile}
            className="fixed inset-0 z-30 bg-black/20 backdrop-blur-xs transition-opacity duration-300 md:hidden"
          />
        )}
