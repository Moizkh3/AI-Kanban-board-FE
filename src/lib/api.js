// ----------------------------------------------------------------------------
// API layer — REAL backend
//
// Talks to the Express server at VITE_API_URL (defaults to localhost:5050).
// Auth token is stored in localStorage and sent as a Bearer header on every
...
// Normalize errors; bounce to /login on 401
